...
<head>
    ...
    <!-- Page Title -->
    <title>Ackley - Coming Soon and Landing Page Template</title>
    ...
    <meta property="og:image" content="http://mixdesign.club/themeforest/ackley/favicon/og-image.webp">
...
<body>
                            ...
                            <div class="container-fluid p-0">
                                <div class="row g-0">
                                    <div class="col-12">
                                        ...
                                        <ul class="navigation">
                                            <li>
                                                <a class="navigation__link link-l-arrow" href="#0"
                                                    id="home-trigger">Home</a>
                                    ...
                                    <div class="col-12 col-md-6 text-start">
                                        <div class="content-block">
                                            <p class="additional-text"><a class="link-s"
                                                    href="mailto:example@example.com?subject=Message%20from%20your%20site">azzamhilme@gmail.com</a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 text-start text-md-end">
                                        <div class="content-block">
                                            <p class="copyright additional-text"><a class="link-s"
                                                    href="https://themeforest.net/user/mix_design/portfolio"
                                                    target="_blank">Mix_Design</a>, 2023</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Main Section Start -->
    <section id="main" class="main main-media-bottom active">
        ...
        <div class="main__content">
            <div class="container-fluid px-0 fullheight">
                <div class="row gx-0 fullheight">
                    <!-- SVG gradient background -->
                    <div class="svg-layer svg-layer-1"></div>
                        ...
                        <div class="intro__content content-top">
                            <div class="container-fluid p-0">
                                <div class="row g-0 align-items-end">
                                    <div class="col-12 col-xl-8">
                                        ...
                                        <div id="headline" class="headline">
                                            <span class="headline__subtitle">
                                                ...
                                                muhammad azzam hilmy
                                            </span>
                                            <h1 class="headline__title">
                                                CREATED BY<br>
                                                <a href="#" style="color: white;">XAZHM</a>
                                            ...
                                            <div class="form-container">
                                                ...
                                                <a href="/auth/login" class="btn btn-l btn-light link-m-opposite"
                                                    type="submit">
                                                    <span class="btn-caption">LARAVEL 13</span>
                                                </a>
                                            </div>
                                        </div>
                                        <!-- Headline End -->
                                    ...
                                    <div class="col-12 col-xl-4 text-start text-xl-end">
                                        ...
                                        <ul class="intro__data">
                                            ...
                                            <li>
                                                <p class="copyright additional-text">DESIGN BY <a class="link-s"
                                                        href="https://themeforest.net/user/mix_design/portfolio"
                                                        target="_blank">Mix_Design</a>, 2023</p>
                                            </li>
                                        </ul>
                    ...
                    <div class="inner__blocks">
                                    ...
                                    <div class="col-12 col-md-6 col-xl-3 four-sells-block">
                                        <div class="contactdata__item">
                                            ...
                                            <p class="contactdata__text"><a class="contact-link link-s"
                                                    href="https://goo.gl/maps/nWXKpGaDPuyH6gxRA" target="_blank">11 West
                                                    53 Street,<br>New York, NY 10019</a></p>
                                        </div>
                                    </div>
                                    <!-- data single item -->
                                    <div class="col-12 col-md-6 col-xl-3 four-sells-block">
                                        <div class="contactdata__item">
                                            ...
                                            <p class="contactdata__text"><a class="contact-link link-s"
                                                    href="https://goo.gl/maps/xap5o3MZBuC6DFHz8" target="_blank">3400
                                    ...
                                    <div class="col-12 col-md-6 col-xl-3 four-sells-block">
                                        <div class="contactdata__item">
                                            ...
                                            <p class="contactdata__text">
                                                <a class="contact-link link-s" href="tel:+12127089400">+1
                                                    212-708-9400</a>
                                                <br>
                                                <a class="contact-link link-s" href="tel:+15104570211">+1
                                                    510-457-0211</a>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-0 d-flex flex-column-reverse flex-lg-row align-items-stretch">
                                    <div class="col-12 col-lg-6 two-sells-block-reverse">
                                        <div class="padding-block">
                                            ...
                                            <p class="block__text">Want to know more about us, tell us about your
                                                project or just to say hello?
                                            ...
                                            <div class="form-container">
                                                ...
                                                <div class="reply-group">
                                                    ...
                                                    <span class="reply-group__text light">Thanks for your message. We
                                                        will get back as soon as possible</span>
                                                </div>
                                                ...
                                                <form class="form form-light contact-form" id="contact-form">
                                                    ...
                                                    <input type="hidden" name="project_name"
                                                        value="Ackley - Coming Soon & Landing Page Template">
                                                    ...
                                                    <input type="email" name="E-mail" placeholder="Email Adress*"
                                                        required>
                                                    <textarea class="margin-s" name="Message" placeholder="A Few Words*"
                                                        required></textarea>
                        ...
                        <a href="mailto:example@example.com?subject=Message%20from%20your%20site"
                            ...
                            <div class="marquee-content scroll">
                                <span>azzamhilme@gmail.com</span>
                                <span>azzamhilme@gmail.com</span>
                                <span>azzamhilme@gmail.com</span>
                            </div>
                            <div class="marquee-content scroll">
        ...
        <div class="popup__container">
            <div class="popup__content">
                ...
                <div class="popup-title">
                    ...
                    <p class="popup-title__text">Subscribe to our newsletter and we will send you a notification about
                        the launch of our brand new site</p>
                </div>
                ...
                <div class="form-container">
                    ...
                    <div class="reply-group subscription-ok">
                        ...
                        <span class="reply-group__text">Thanks for subscribing. We will send you a notification about
                            our launch.</span>
                    </div>
        ...
        <div class="popup__container">
            <div class="popup__content">
                ...
                <div class="popup-title">
                    ...
                    <p class="popup-title__title">tasks</p>
                </div>
